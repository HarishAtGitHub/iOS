...
- (void)browserLoadStart:(NSURL*)url
{
    if (self.callbackId != nil) {
        CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK
                                                      messageAsDictionary:[NSDictionary dictionaryWithObjectsAndKeys:@"type",@"loadstart", @"url",[url absoluteString],nil]];
        [pluginResult setKeepCallback:[NSNumber numberWithBool:YES]];
...
- (void)browserLoadStop:(NSURL*)url
{
    if (self.callbackId != nil) {
        CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK
                                                      messageAsDictionary:[NSDictionary dictionaryWithObjectsAndKeys:@"type",@"loadstop", @"url",[url absoluteString],nil]];
        [pluginResult setKeepCallback:[NSNumber numberWithBool:YES]];
...
- (void)browserExit
{
    if (self.callbackId != nil) {
        CDVPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK
                                                      messageAsDictionary:[NSDictionary dictionaryWithObjectsAndKeys:@"type",@"exit",nil]];
        [pluginResult setKeepCallback:[NSNumber numberWithBool:YES]];
...
- (void)createViews
{
    ...
    [self.toolbar setItems:[NSDictionary dictionaryWithObjectsAndKeys:self.closeButton, flexibleSpaceButton, self.backButton, fixedSpaceButton, self.forwardButton,nil]];
